...
class Form(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
     ...
     #Initialization for TAB-1
        ...
        self._thread_1 = None #Initialization to the un-defined thread value Used at 'Repetitive Tasks'
        self._tl_1 = None     #Initialization to the un-defined Telnet object value Used at 'Repetitive Tasks'
